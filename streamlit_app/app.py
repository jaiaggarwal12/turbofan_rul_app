...
def load_fd001_test_raw():
    """
    Load NASA FD001 TEST dataset safely
    """
...
# -------------------------------------------------
engine_html = """
<div style="width:100%; height:320px; border-radius:14px; overflow:hidden;
background:radial-gradient(circle at 20% 20%, #283046 0, #050814 45%, #02030a 100%);
...
.fan-blades { transform-origin:130px 130px; animation: spinFan 2.8s linear infinite; }
</style>
"""
...
if page == "Predict RUL":
    ...
    if uploaded_file:
        ...
        st.dataframe(df_engine.head(), use_container_width=True)
        ...
        if st.button("🔮 Predict RUL"):
            ...
            st.metric("Predicted RUL (cycles)", f"{pred_rul:.1f}")
